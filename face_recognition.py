...
class Face_Recognition(object):
    ...
    #    first image i.e lef
        ...
        # second image i.e right
        img_bottom = Image.open(r"college_images\facial_recognition_system_identification.jpg")
    ...
    def marck_attendance(self,i ,r, n, d):
    ...
    def face_recog(self):
        def draw_boundray(img,classifier, scaleFactor, minNeighbours, colour, text, clf):
            ...
            for (x,y,w,h) in features:
                ...
                # confidence less confidence consider as good
                ...
                # adjust the confidence level id dont find the details in output
