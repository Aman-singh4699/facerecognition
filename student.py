...
class Student:
    def __init__(self,root):
        ...
        img_left = Image.open(r"C:\Users\Aman Kumar\pythonProject\face-recognition-attendance\college_images\AdobeStock_303989091.JPEG")
        ...
        img_right = Image.open(r"C:\Users\Aman Kumar\pythonProject\face-recognition-attendance\college_images\smart-attendance.JPG")
        ...
        self.student_table.heading("course", text="Couser")
    ...
    # fucntion declarations for database
    ...
    def add_data(self):
        if self.var_dep.get() == "select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                conn = mysql.connector.connect(host="localhost",user="root",password="Aman@2001", database="face_recognizer")      
        ...
        if self.var_dep.get() == "select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                ...
                conn.close()
                        ...
                        # using har cascade load predefined data on face frontals
                ...
                messagebox.showinfo("Result", "generating data sets competed !!")
            except Exception as es:
                messagebox.showerror("Error", f"Due to: {str(es)}", parent=self.root)
